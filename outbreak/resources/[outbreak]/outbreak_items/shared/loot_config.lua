LootCfg = {
  ...
  Tables = {
    ...
    house   = { { 'canned_beans', 1, 2, 0.35 }, { 'can_opener', 1, 1, 0.12 }, { 'bandage', 1, 1, 0.20 }, { 'map_scrap', 1, 1, 0.05 }, { 'radio_base', 1, 1, 0.02 }, { 'ammo-9', 4, 9, 0.08 }, { 'WEAPON_KNIFE', 1, 1, 0.04 }, { 'gun_oil', 1, 1, 0.03 }, { 'note', 1, 3, 0.20 }, { 'padlock', 1, 1, 0.05 }, { 'duffel_bag', 1, 1, 0.04 } },
    tools   = { { 'hammer_tool', 1, 1, 0.20 }, { 'nails', 1, 1, 0.35 }, { 'plank', 1, 2, 0.30 }, { 'gas_can_small', 1, 1, 0.10 }, { 'crowbar_tool', 1, 1, 0.15 }, { 'car_battery', 1, 1, 0.08 }, { 'hose_kit', 1, 1, 0.12 }, { 'engine_parts', 1, 1, 0.07 }, { 'key_blank', 1, 1, 0.06 }, { 'radio_coil', 1, 1, 0.03 }, { 'ammo-shotgun', 2, 6, 0.05 }, { 'WEAPON_HATCHET', 1, 1, 0.03 }, { 'crate', 1, 1, 0.05 }, { 'padlock', 1, 1, 0.06 } },
