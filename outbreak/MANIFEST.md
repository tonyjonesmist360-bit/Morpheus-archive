...
Pack: outbreak v0.16.0 — 24 slice resources, 8 extended, 2 progression; 8 migrations, 23 tables. Lua 5.4 everywhere (`lua54 'yes'`). All resources `fx_version 'cerulean'`.
