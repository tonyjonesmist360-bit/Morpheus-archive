...
Pack: outbreak v0.24.0 — 31 slice resources (outbreak_tuning, outbreak_log new), 9 migrations, 24 tables; 8 extended (vehicles + craft ensured), 2 progression (ensured); 8 migrations, 23 tables. Lua 5.4 everywhere (`lua54 'yes'`). All resources `fx_version 'cerulean'`.
